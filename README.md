...
`heim` has a few key goals which define its development and public interface:
 ...
 1. [Cross-platform](https://heim-rs.github.io/book/introduction/platforms.html) with [platform-specific extensions](https://heim-rs.github.io/book/api/platform-specific.html).
 2. Modular design.
 3. Idiomatic and easy to use.
